...
document.querySelectorAll("img")[1].setAttribute("src", randomConcatSrc);
/*document.getElementsByClassName("img1")[0].src="./images/dice6.png";*/
document.querySelectorAll("img")[1].setAttribute("alt", alternativeText1); 

var randomNumber2=Math.floor(Math.random()*6)+1;
var randomConcat= "./images/"+ "dice" + randomNumber2 + ".png";
var alternativeText2="A six-sided dice showing"+ randomNumber2;
document.querySelectorAll("img")[2].setAttribute("src", randomConcat );
document.querySelectorAll("img")[2].setAttribute("alt", alternativeText2); 
